<?php
/**
 * The KayMozCeramics_Admin class defines all functionality for the admin/back-end/dashboard stuff
 * 
...
class KayMozCeramics_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style(
			'kmc-admin-styles',
			plugin_dir_url( __FILE__ ) . 'css/kmc-admin-style.css',
			array(),
			filemtime( plugin_dir_url( __FILE__ ) . 'css/kmc-admin-style.css' ),
			FALSE
		);
