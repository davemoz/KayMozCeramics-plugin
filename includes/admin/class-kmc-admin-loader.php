<?php
/**
 * Custom Admin stuff loader
 * 
 * @package     KayMozCeramics
 */

/**
 * The KayMozCeramics_Admin_Loader is a class that is responsible for coordinating all actions and filters used through the admin portion of the plugin.
 * 
 * This class maintains two internal collections - one for actions, one for hooks - each of which are coordinated through external classes that register the various hooks throughout this class.
 *
 * @since 1.0.0
 */
class KayMozCeramics_Admin_Loader {
   ...
   *
   * @access protected
   * @var    array    $filters    The array of filters that are defined throughout the plugin.
   */
	protected $filters;

	/**
	 * Instantiates the plugin by setting up the data structures that will be used to maintain the actions and the filters.
	 */
